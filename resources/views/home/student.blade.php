        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  mg-tb-30 sm-res-mg-t-0 dasboard_card" >
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  " >
                    <input id="cari" type="text" class="form-control mg-tb-30 sm-res-mg-t-0" name="cari" value="" style="width:15%" style="padding-right:20%">
                ...
                success : function(data){
                    ...
                    $(".profile_perusahaan").append(
                        ...
                        "<table style='width:100%;font-size:20px'>"+
                            ...
                            "<tr><th>Kategori</th><th style='5%'>:</th><th>"+data.company.kategori+"</th></tr>"+
