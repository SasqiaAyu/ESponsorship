                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row div-company">
                            ...
                            <div class="col-md-6">
                                {{-- <input id="kategori" type="text"
                                    class="form-control input-company @error('kategori') is-invalid @enderror" name="kategori"
                                    value="{{ old('kategori') }}" required autocomplete="kategori" autofocus> --}}

                                    <select id="kategori" class="form-control "
                                    name="kategori" autocomplete="kategori" autofocus>
                        ...
                        <div class="form-group row div-student">
                            ...
                            <div class="col-md-6">
                                <input id="nama" type="text" class="form-control input-student @error('nama') is-invalid @enderror"
                        ...
                        <div class="form-group row div-student">
                            <label for="foto_nim"
                                class="col-md-4 col-form-label text-md-right">{{ __('Foto NIM (JPG/PNG)') }}</label>

                            <div class="col-md-6">
                                <input id="foto_nim" type="file" class="form-control input-student @error('foto_nim') is-invalid @enderror"
                                    name="foto_nim" value="{{ old('foto_nim') }}" required autocomplete="foto_nim">
                        ...
                        <div class="form-group row">
                            <label for="foto"
                                class="col-md-4 col-form-label text-md-right">{{ __('Foto User (JPG/PNG)') }}</label>
