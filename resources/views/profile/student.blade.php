                        ...
                        <div class="form-group">
                            ...
                            <div class="nk-int-st">
                                <input type="text" class="form-control input-sm" name="fakultas"
                                    placeholder="Masukkan Fakultas" value="{{old('fakultas')?old('fakultas'):auth()->user()->student->fakultas}}">
                                @error('fakultas')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="nk-int-st">
                                <input type="text" class="form-control input-sm" name="jurusan"
                                    placeholder="Masukkan Jurusan" value="{{old('jurusan')?old('jurusan'):auth()->user()->student->jurusan}}">
                                @error('jurusan')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
